(function () {
  const B = {
    ...
    ES: {
      ...
      "Get your listing, your story page, your menu and a shot at the weekly spotlight for": "Tu ficha, tu página de historia, tu menú y la chance de salir en candela el viernes por",
      "a month. Cancel whenever.": "al mes. Cancela cuando quieras.",
      "JOIN FOR": "ENTRA POR",
      "/MO": "/MES",
      ...
      "One flat price. Your listing on your own city page, a full story page, your menu or service list, and rotation into the Friday spotlight.": "Un solo precio. Tu ficha en la página de tu ciudad, una página de historia completa, tu menú o lista de servicios, y entrada a la rotación del destacado del viernes.",
      "MEMBER LISTING": "FICHA DE SOCIO",
      "PER MONTH · NO CONTRACT": "AL MES · SIN CONTRATO",
      "FIRST 30 DAYS FREE": "LOS PRIMEROS 30 DÍAS GRATIS",
      ...
      "START MY 30 FREE DAYS": "EMPIEZA MIS 30 DÍAS GRATIS",
      "Then": "Después",
      "/month. Cancel from your dashboard any time.": "/mes. Cancela desde tu panel cuando quieras.",
      ...
      "GET YOUR SHOP ON THE MAP — FREE": "PON TU NEGOCIO EN EL MAPA — GRATIS",
      ...
      "We print your tap-to-open card and build the landing page it opens — menu, hours, directions, all of it.": "Te imprimimos la tarjeta de un toque y te hacemos la página que abre — menú, horario, cómo llegar, todo.",
      ...
      "Our AI receptionist answers your phone in English or Spanish, takes reservations and texts you the details. Free while we test it — tell us in the form below if you want in.": "Nuestra recepcionista de IA contesta en inglés o español, toma reservaciones y te manda los detalles por mensaje. Gratis mientras la probamos.",
      "Menu, promo or contact QR codes we host for you. Change where they point anytime, the sticker stays the same.": "Códigos QR de menú, promoción o contacto que nosotros alojamos. Cambia a dónde apuntan cuando quieras, la pegatina sigue igual.",
      "A real story page": "Una página de historia de verdad",
      "We interview you and write it. Menu, services, hours, gallery included.": "Te entrevistamos y la escribimos. Menú, servicios, horario y galería incluidos.",
    ...
    EV_ES: {
      ...
      "Every domino table, live band, watch party and free city day worth leaving the house for. Members post theirs free — the city ones we hunt down ourselves.": "Cada mesa de dominó, banda en vivo, party pa' ver el juego y día gratis de la ciudad que vale salir de la casa. Los socios ponen los suyos gratis — los de la ciudad los cazamos nosotros.",
      "LIST": "LISTA",
      "CALENDAR": "CALENDARIO",
    ...
    return {
      ...
      joinBandP1: T('Get your listing, your story page, your menu and a shot at the weekly spotlight for'), joinBandP2: T('a month. Cancel whenever.'),
      joinFor: T('JOIN FOR'), perMo: T('/MO'),
      ...
      verifiedMember: T('VERIFIED MEMBER'), theStory: T('THE STORY'), readFull: T('READ THE FULL STORY →'), theMenu: T('THE MENU'),
      ...
      joinP: T('One flat price. Your listing on your own city page, a full story page, your menu or service list, and rotation into the Friday spotlight.'),
      betaKicker: T('BETA · AI RECEPTIONIST'), betaH: T("WE'RE LOOKING FOR BETA TESTERS."),
      betaP: T('Our AI receptionist answers your phone in English or Spanish, takes reservations and texts you the details. Free while we test it — tell us in the form below if you want in.'),
      memberListing: T('MEMBER LISTING'), perMonthNoContract: T('PER MONTH · NO CONTRACT'), first30: T('FIRST 30 DAYS FREE'), claim: T('CLAIM YOUR LISTING'),
      ...
      startFree: T('START MY 30 FREE DAYS'), thenP1: T('Then'), thenP2: T('/month. Cancel from your dashboard any time.'),
